...
def default_records() -> list[ModelInfo]:
    return [
        ...
        # --- Quantized (flagship models; no cost, Quantized bills in credits) ---
        ModelInfo(
            provider="quantized",
            model="anthropic/claude-opus-4.6",
            display_name="Claude Opus 4.6 (Quantized)",
        ...
        ModelInfo(
            ...
            display_name="Claude Haiku 4.5 (Quantized)",
            context_window=200000,
            max_tokens=64000,
            supports_image_input=True,
            supports_tools=True,
        ...
        ModelInfo(
            ...
            display_name="GPT-5.1 (Quantized)",
            context_window=400000,
            max_tokens=128000,
            supports_image_input=True,
            supports_tools=True,
            supports_structured_output="loose",
            supports_reasoning=True,
        ),
        ModelInfo(
            provider="quantized",
            model="openai/gpt-4o-mini",
            display_name="GPT-4o mini (Quantized)",
            context_window=128000,
            max_tokens=16384,
            supports_image_input=True,
            supports_tools=True,
        ...
        ModelInfo(
            ...
            display_name="DeepSeek V3.2 (Quantized)",
            context_window=128000,
            max_tokens=64000,
            supports_tools=True,
            supports_structured_output="loose",
        ...
        ModelInfo(
            ...
            display_name="DeepSeek R1 0528 (Quantized)",
        ...
        ModelInfo(
            ...
            display_name="Qwen3 235B A22B (Quantized)",
        ...
        ModelInfo(
            ...
            display_name="Llama 3.3 70B Instruct (Quantized)",
            context_window=131072,
            max_tokens=16384,
            supports_tools=True,
            supports_structured_output="loose",
