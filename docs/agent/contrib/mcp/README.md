...
## 2. One connection per server, for the life of the process
...
## 3. The tool list is cached, and the cache is durable
...
## 6. Where the state lives, and why
...
**`subscriptions/listen`.** See section 3.
...
Next: [contrib packages](../README.md)
