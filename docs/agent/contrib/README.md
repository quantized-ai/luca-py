...
| [`compaction/`](compaction/README.md) | `SummarizingCompactionPolicy` — a ready-made `CompactionPolicy` (the context gauge + an LLM summary) with pluggable keep-strategies |
