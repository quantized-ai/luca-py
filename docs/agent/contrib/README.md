...
| [`websearch/`](websearch/README.md) | Provider-hosted web search/fetch: the hosted declarations when the active model supports them + one durable synthetic execution per recorded operation — no dispatch, no approval gate |
