...
| [`06-tools.md`](06-tools.md) | Defining tools, calling them in a loop, parsing arguments, provider-defined tools |
...
| [`09-providers-and-transports.md`](09-providers-and-transports.md) | Provider registry, `PROVIDERS` config, adding hosts, lower-level entry points, which transports serve provider-defined tools |
